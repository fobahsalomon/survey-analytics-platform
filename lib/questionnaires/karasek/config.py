# -*- coding: utf-8 -*-
"""
config.py — Configuration du module Karasek
Mapping des items, règles de scoring, seuils, palettes, labels.
...
CATEGORY_LABELS: Tuple[str, str, str] = ("Faible", "Moyen", "Élevé")

# ===========================================================================
# MAPPING RENOMMAGE ITEMS LIKERT
# Clé  = libellé exact dans le CSV source (apostrophes typographiques \u2019)
# Valeur = nom court interne (Qx_suffixe)
# ===========================================================================
...
# ===========================================================================
# ITEMS À INVERSER (après renommage)
# ===========================================================================
INVERT_ITEMS: List[str] = ["Q2_auto", "Q2_comp", "Q4_dem", "Q1_rec", "Q2_rec"]

# ===========================================================================
# RÈGLES DE SCORING
# score = sommes_items × multiplicateur
# ===========================================================================
...
ALL_SCORE_COLS: List[str] = [
    ...
    "rec_score", "equ_score", "cult_score",
    "adq_resources_score", "adq_role_score", "sat_score",
]

# ===========================================================================
# LABELS LISIBLES (graphiques et rapports)
# ===========================================================================
VAR_LABELS: Dict[str, str] = {
    ...
    "Dem_score_quant_cat":           "le niveau de demande psychologique",
    "Lat_score_quant_cat":           "le niveau de latitude décisionnelle",
    "SS_score_quant_cat":            "le niveau de soutien social",
    "comp_score_quant_cat":          "le niveau d'utilisation des compétences",
    "auto_score_quant_cat":          "le niveau d'autonomie décisionnelle",
    "sup_score_quant_cat":           "le niveau de soutien hiérarchique",
    "col_score_quant_cat":           "le niveau de soutien des collègues",
    "rec_score_quant_cat":           "le niveau de reconnaissance",
    "equ_score_quant_cat":           "le niveau d'équité de charge",
    "cult_score_quant_cat":          "le niveau d'adhésion à la culture",
    "adq_resources_score_quant_cat": "le niveau d'adéquation ressources / objectifs",
    "adq_role_score_quant_cat":      "le niveau d'adéquation formation / rôle",
    "sat_score_quant_cat":           "le niveau de satisfaction au travail",
    "Karasek_quadrant":          "le quadrant de Karasek",
    "Karasek_quadrant_internal": "le quadrant de Karasek",
    "Job_strain":                "le Job Strain",
    "Job_strain_internal":       "le Job Strain",
    "Iso_strain":                "l'Isolement au Travail",
    "Iso_strain_internal":       "l'Isolement au Travail",
}
...
MODALITY_ORDER: Dict[str, List[str]] = {
    "Genre":                 ["Homme", "Femme"],
    "Situation matrimonial": ["Célibataire", "Marié(e)", "Concubinage", "Divorcé(e)", "Veuf/Veuve"],
    ...
    "Avez-vous \u00e9t\u00e9 suivi pour un probleme psychologique *": ["Non", "Oui"],
...
SCORE_CAT_ORDER: List[str] = ["Faible", "Moyen", "Élevé"]

# ===========================================================================
# VARIABLES À VISUALISER (barplots simples)
# ===========================================================================
CAT_VARS: List[str] = [
    "Genre",
...
# TABLEAUX CROISÉS
# ===========================================================================
CROSSTABS_RISK_CORE: List[Tuple[str, str]] = [
    ("Genre",                           "Karasek_quadrant_internal"),
    ("Tranche_age",                     "Karasek_quadrant_internal"),
    ("Tranche_anciennete",              "Karasek_quadrant_internal"),
    ("Categorie_IMC",                   "Karasek_quadrant_internal"),
    ("IMC_binaire",                     "Karasek_quadrant_internal"),
    ("Avez-vous une maladie chronique", "Karasek_quadrant_internal"),
    ("Pratique reguliere du sport",     "Karasek_quadrant_internal"),
    ("Direction",                       "Karasek_quadrant_internal"),
    ("Cat\u00e9gorie Socio",            "Karasek_quadrant_internal"),
    ("Situation matrimoniale",          "Karasek_quadrant_internal")
]

CROSSTABS_SOCIO_RPS: List[Tuple[str, str]] = [
    ("Genre",                           "Iso_strain_internal"),
    ("Tranche_age",                     "Iso_strain_internal"),
    ("Tranche_anciennete",              "Iso_strain_internal"),
    ("Categorie_IMC",                   "Iso_strain_internal"),
    ("Avez-vous une maladie chronique", "Iso_strain_internal"),
    ("Situation matrimoniale",          "Iso_strain_internal"),
    
    ("Genre",                           "Job_strain_internal"),
    ("Tranche_age",                     "Job_strain_internal"),
    ("Tranche_anciennete",              "Job_strain_internal"),
    ("Categorie_IMC",                   "Job_strain_internal"),
    ("Pratique reguliere du sport",     "Job_strain_internal"),
    ("Avez-vous une maladie chronique", "Job_strain_internal"),
    ("Situation matrimoniale",          "Job_strain_internal")
    
]

CROSSTABS_CLIMATE: List[Tuple[str, str]] = [
    ("sat_score_quant_cat",  "cult_score_quant_cat"),
    ("Genre",                "cult_score_quant_cat"),
    ("Tranche_age",          "cult_score_quant_cat"),
    ("Tranche_anciennete",   "cult_score_quant_cat"),
    ("Genre",                "equ_score_quant_cat"),
    ("Tranche_age",          "equ_score_quant_cat"),
    ("Tranche_anciennete",   "equ_score_quant_cat"),
]

CROSSTABS_SOCIO_CLIMATE: List[Tuple[str, str]] = [
    ("SS_score_quant_cat",            "sat_score_quant_cat"),
    ("col_score_quant_cat",           "sat_score_quant_cat"),
    ("sup_score_quant_cat",           "sat_score_quant_cat"),
    ("rec_score_quant_cat",           "sat_score_quant_cat"),
    ("equ_score_quant_cat",           "sat_score_quant_cat"),
    ("adq_resources_score_quant_cat", "sat_score_quant_cat"),
    ("adq_role_score_quant_cat",      "sat_score_quant_cat"),
    ("Genre",                         "rec_score_quant_cat"),
    ("Tranche_age",                   "rec_score_quant_cat"),
    ("Tranche_anciennete",            "rec_score_quant_cat"),
]

ALL_CROSSTABS: List[Tuple[str, str]] = (
    CROSSTABS_RISK_CORE
    + CROSSTABS_SOCIO_RPS
    + CROSSTABS_CLIMATE
...
# PALETTES GRAPHIQUES
# ===========================================================================
KARASEK_PALETTE: Dict[str, str] = {
    "Actif":   "#2ca02c",
    "Detendu": "#1f77b4",
    "Tendu":   "#d62728",
    "Passif":  "#7f7f7f",
}
STRAIN_PALETTE: Dict[str, str] = {"Présent": "#d62728", "Absent": "#2ca02c"}
